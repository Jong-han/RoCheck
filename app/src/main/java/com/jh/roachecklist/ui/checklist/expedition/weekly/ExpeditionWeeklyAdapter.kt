...
class ExpeditionWeeklyAdapter( private val onChecked: (View, Int)->(Unit), private val onClickNoti: (Int)->(Unit) ): ListAdapter<CheckListEntity, ExpeditionWeeklyAdapter.ExpeditionWeeklyViewHolder>( ExpeditionDiffUtil() ) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ExpeditionWeeklyViewHolder {
        ...
        return ExpeditionWeeklyViewHolder( binding )
    }

    override fun onBindViewHolder(holder: ExpeditionWeeklyViewHolder, position: Int) {

        holder.bind( currentList[position] )

    }

    inner class ExpeditionWeeklyViewHolder( private val binding: ActivityCheckListItemBinding): RecyclerView.ViewHolder( binding.root ) {
